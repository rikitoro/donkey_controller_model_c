...
*   Version     : 1.03  ( 2005-04-29 )                                      *
*   Version     : 1.04  ( 2005-05-09 )                                      *
*****************************************************************************/
/*
  note:
...
------------------------------------------------------*/
union byte_def c01wkic_addr;
#define     c01wkic     c01wkic_addr.byte

#define     ilvl0_c01wkic   c01wkic_addr.bit.b0     /* Interrupt priority level select bit */
#define     ilvl1_c01wkic   c01wkic_addr.bit.b1     /* Interrupt priority level select bit */
#define     ilvl2_c01wkic   c01wkic_addr.bit.b2     /* Interrupt priority level select bit */
#define     ir_c01wkic      c01wkic_addr.bit.b3     /* Interrupt request bit */

/*------------------------------------------------------
    CAN0 error interrupt control register
------------------------------------------------------*/
union byte_def c01erric_addr;
#define     c01erric    c01erric_addr.byte

#define     ilvl0_c01erric  c01erric_addr.bit.b0
#define     ilvl1_c01erric  c01erric_addr.bit.b1
#define     ilvl2_c01erric  c01erric_addr.bit.b2
#define     ir_c01erric     c01erric_addr.bit.b3

/*------------------------------------------------------
    CAN0 successful reception interrupt control register
------------------------------------------------------*/
union byte_def c0recic_addr;
#define     c0recic     c0recic_addr.byte

#define     ilvl0_c0recic  c0recic_addr.bit.b0
#define     ilvl1_c0recic  c0recic_addr.bit.b1
#define     ilvl2_c0recic  c0recic_addr.bit.b2
#define     ir_c0recic     c0recic_addr.bit.b3

/*------------------------------------------------------
    CAN0 successful transmission interrupt control register
------------------------------------------------------*/
union byte_def c0trmic_addr;
#define     c0trmic     c0trmic_addr.byte

#define     ilvl0_c0trmic  c0trmic_addr.bit.b0
#define     ilvl1_c0trmic  c0trmic_addr.bit.b1
#define     ilvl2_c0trmic  c0trmic_addr.bit.b2
#define     ir_c0trmic     c0trmic_addr.bit.b3
...
#define     mod0_g1pocr0 g1pocr0_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr0 g1pocr0_addr.bit.b1      /* Operation mode select bit */
...
#define     mod0_g1pocr1 g1pocr1_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr1 g1pocr1_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr1  g1pocr1_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr1  g1pocr1_addr.bit.b5       /* g1po1 register value reload timing select bit */
#define     inv_g1pocr1  g1pocr1_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr2 g1pocr2_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr2 g1pocr2_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr2  g1pocr2_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr2  g1pocr2_addr.bit.b5       /* g1po2 register value reload timing select bit */
#define     inv_g1pocr2  g1pocr2_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr3 g1pocr3_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr3 g1pocr3_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr3  g1pocr3_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr3  g1pocr3_addr.bit.b5       /* g1po3 register value reload timing select bit */
#define     inv_g1pocr3  g1pocr3_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr4 g1pocr4_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr4 g1pocr4_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr4  g1pocr4_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr4  g1pocr4_addr.bit.b5       /* g1po4 register value reload timing select bit */
#define     inv_g1pocr4  g1pocr4_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr5 g1pocr5_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr5 g1pocr5_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr5  g1pocr5_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr5  g1pocr5_addr.bit.b5       /* g1po5 register value reload timing select bit */
#define     inv_g1pocr5  g1pocr5_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr6 g1pocr6_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr6 g1pocr6_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr6  g1pocr6_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr6  g1pocr6_addr.bit.b5       /* g1po6 register value reload timing select bit */
#define     inv_g1pocr6  g1pocr6_addr.bit.b7       /* Inverse output function select bit */
/*------------------------------------------------------
...
#define     mod0_g1pocr7 g1pocr7_addr.bit.b0      /* Operation mode select bit */
#define     mod1_g1pocr7 g1pocr7_addr.bit.b1      /* Operation mode select bit */
#define     ivl_g1pocr7  g1pocr7_addr.bit.b4       /* Output initial value select bit */
#define     rld_g1pocr7  g1pocr7_addr.bit.b5       /* g1po7 register value reload timing select bit */
#define     inv_g1pocr7  g1pocr7_addr.bit.b7       /* Inverse output function select bit */
...
#define     cts0_g1tmcr0 g1tmcr0_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr0 g1tmcr0_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     cts0_g1tmcr1 g1tmcr1_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr1 g1tmcr1_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr1  g1tmcr1_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr1  g1tmcr1_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr1   g1tmcr1_addr.bit.b7        /* Prescaler function select bit */
...
#define     cts0_g1tmcr2 g1tmcr2_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr2 g1tmcr2_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr2  g1tmcr2_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr2  g1tmcr2_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr2   g1tmcr2_addr.bit.b7        /* Prescaler function select bit */
...
#define     cts0_g1tmcr3 g1tmcr3_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr3 g1tmcr3_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr3  g1tmcr3_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr3  g1tmcr3_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr3   g1tmcr3_addr.bit.b7        /* Prescaler function select bit */
...
#define     cts0_g1tmcr4 g1tmcr4_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr4 g1tmcr4_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr4  g1tmcr4_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr4  g1tmcr4_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr4   g1tmcr4_addr.bit.b7        /* Prescaler function select bit */
...
#define     cts0_g1tmcr5 g1tmcr5_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr5 g1tmcr5_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr5  g1tmcr5_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr5  g1tmcr5_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr5   g1tmcr5_addr.bit.b7        /* Prescaler function select bit */
...
#define     cts0_g1tmcr6 g1tmcr6_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr6 g1tmcr6_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr6  g1tmcr6_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr6  g1tmcr6_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr6   g1tmcr6_addr.bit.b7        /* Prescaler function select bit */
/*------------------------------------------------------
...
#define     cts0_g1tmcr7 g1tmcr7_addr.bit.b0      /* Timer measurement trigger select bit */
#define     cts1_g1tmcr7 g1tmcr7_addr.bit.b1      /* Timer measurement trigger select bit */
...
#define     goc_g1tmcr7  g1tmcr7_addr.bit.b5       /* Gate function clear select bit */
#define     gsc_g1tmcr7  g1tmcr7_addr.bit.b6       /* Gate function clear bit */
#define     pr_g1tmcr7   g1tmcr7_addr.bit.b7        /* Prescaler function select bit */
...
#define     dms_dm0sl   dm0sl_addr.bit.b6          /* DMA request cause expansion bit */
...
#define     dms_dm1sl   dm1sl_addr.bit.b6          /* DMA request cause expansion bit */
...
#define     g1btrrl g1btrr_addr.byte.low            /* Base timer reset register low  8 bit */
#define     g1btrrh g1btrr_addr.byte.high           /* Base timer reset register high 8 bit */
...
#define     c0conr      c0conr_addr.word            /*  CAN0 configuration reigster  */
#define     c0conrl     c0conr_addr.byte.low        /*  CAN0 configuration reigster low  8 bit */
#define     c0conrh     c0conr_addr.byte.high       /*  CAN0 configuration reigster high 8 bit */
...
#define     c0tsr      c0tsr_addr.word            /*  CAN0 time stamp register  */
#define     c0tsrl     c0tsr_addr.byte.low        /*  CAN0 time stamp register low  8 bit */
#define     c0tsrh     c0tsr_addr.byte.high       /*  CAN0 time stamp register high 8 bit */
